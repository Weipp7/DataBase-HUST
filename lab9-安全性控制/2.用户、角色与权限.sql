...
insert,
update
    on client to client_manager;

# (3) 授予client_manager对bank_card表拥有查询除银行卡余额外的select权限；
grant
select (b_number, b_type, b_c_id) on bank_card to client_manager;
...
grant
    client_manager to 'tom',
    'jerry';

# (6) 将fund_manager权限授予用户Cindy. grant fund_manager to 'Cindy';