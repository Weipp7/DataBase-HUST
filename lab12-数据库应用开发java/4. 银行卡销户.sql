...
public class RemoveCard{static final String JDBC_DRIVER = "com.mysql.cj.jdbc.Driver";
...
public static int removeBankCard(
...
try{String sql = "delete from bank_card where b_c_id = ? and b_number = ?";
...
if (n > 0){System.out.println("已销卡数：" + n);

}
else{System.out.println("销户失败，请检查客户编号或银行卡号！");
