...
public class Client{public static void main(String [] args){Connection connection = null;

Statement statement = null;

ResultSet resultSet = null;

try{String SQL = "select * from client where c_mail is not null;";
...
while (resultSet.next()){System.out.print(
...
System.out.println(resultSet.getString("c_phone"));
    ...
    "Sorry,can`t find the JDBC Driver!"
);
